...
namespace strateam{
    namespace equipment{
        ...
        public:
            ...
            virtual MotionResult squeeze( dim::Gram const& minSignalValueToDetect, dim::Gram const& signalDeltaF, dim::MilliSecond const& stableTimeDetection, dim::UmVelocity const& haydonVelocity, dim::UmVelocity const& beamVelocity ) = 0;
